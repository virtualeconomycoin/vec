...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Virtualeconomycoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"virtualeconomycointools.com", "dnsseed.virtualeconomycointools.com"},
    {"virtualeconomycoinpool.org", "dnsseed.virtualeconomycoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"virtualeconomycointools.com", "testnet-seed.virtualeconomycointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Virtualeconomycoin is probably already running."), addrBind.ToString().c_str());
        else
